! function(t) {
    ...
    function o() {
        k.datepicker._isDisabledDatepicker((z.inline ? z.dpDiv.parent() : z.input)[0]) || (k(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), k(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") && k(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") && k(this).addClass("ui-datepicker-next-hover"))
    }
    ...
    k.cleanData = (F = k.cleanData, function(t) {
        ...
        return e || (e = i, i = k.Widget), k.isArray(e) && (e = k.extend.apply(null, [{}].concat(e))), k.expr[":"][h.toLowerCase()] = function(t) {
            ...
            return k.isFunction(s) ? void(a[e] = function() {
                var t, e = this._super,
                    i = this._superApply;
        ...
        _classes: function(n) {
            function t(t, e) {
                for (var i, s = 0; t.length > s; s++) i = a.classesElementLookup[t[s]] || k(), i = n.add ? k(k.unique(i.get().concat(n.element.get()))) : k(i.not(n.element).get()), a.classesElementLookup[t[s]] = i, o.push(t[s]), e && n.classes[t[s]] && o.push(n.classes[t[s]])
            }
            var o = [],
                a = this;
            return n = k.extend({
        ...
        _on: function(n, o, t) {
            ...
            "boolean" != typeof n && (t = o, o = n, n = !1), t ? (o = a = k(o), this.bindings = this.bindings.add(o)) : (t = o, o = this.element, a = this.widget()), k.each(t, function(t, e) {
                function i() {
                    return n || !0 !== r.options.disabled && !k(this).hasClass("ui-state-disabled") ? ("string" == typeof e ? r[e] : e).apply(r, arguments) : void 0
                }
    ...
    }), k.widget, x = Math.max, C = Math.abs, n = /left|center|right/, a = /top|center|bottom/, r = /[\+\-]\d+(\.[\d]+)?%?/, l = /^\w+/, c = /%$/, E = k.fn.position, k.position = {
        scrollbarWidth: function() {
            var t, e, i;
            return void 0 !== s ? s : (i = (e = k("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>")).children()[0], k("body").append(e), t = i.offsetWidth, e.css("overflow", "scroll"), t === (i = i.offsetWidth) && (i = e[0].clientWidth), e.remove(), s = t - i)
        },
        ...
        return _[0].preventDefault && (u.at = "left top"), p = e.width, f = e.height, m = k.extend({}, g = e.offset), k.each(["my", "at"], function() {
            ...
            (i = 1 === i.length ? n.test(i[0]) ? i.concat(["center"]) : a.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = n.test(i[0]) ? i[0] : "center", i[1] = a.test(i[1]) ? i[1] : "center", t = r.exec(i[0]), e = r.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], u[this] = [l.exec(i[0])[0], l.exec(i[1])[0]]
        }), 1 === y.length && (y[1] = y[0]), "right" === u.at[0] ? m.left += p : "center" === u.at[0] && (m.left += p / 2), "bottom" === u.at[1] ? m.top += f : "center" === u.at[1] && (m.top += f / 2), d = B(w.at, p, f), m.left += d[0], m.top += d[1], this.each(function() {
            var i, t, a = k(this),
                r = a.outerWidth(),
                h = a.outerHeight(),
                e = D(this, "marginLeft"),
                ...
                l = k.extend({}, m),
                c = B(w.my, a.outerWidth(), a.outerHeight());
            "right" === u.my[0] ? l.left -= r : "center" === u.my[0] && (l.left -= r / 2), "bottom" === u.my[1] ? l.top -= h : "center" === u.my[1] && (l.top -= h / 2), l.left += c[0], l.top += c[1], i = {
                ...
                p < r && p > C(e + i) && (o.horizontal = "center"), f < h && f > C(s + n) && (o.vertical = "middle"), o.important = x(C(e), C(i)) > x(C(s), C(n)) ? "horizontal" : "vertical", u.using.call(this, t, o)
            }), a.offset(k.extend(l, {
                using: t
            }))
        })
        ...
        flip: {
            left: function(t, e) {
                var i = e.within,
                    ...
                    l = -2 * e.offset[0];
                a < 0 ? ((n = t.left + r + h + l + e.collisionWidth - n - s) < 0 || C(a) > n) && (t.left += r + h + l) : 0 < o && (0 < (s = t.left - e.collisionPosition.marginLeft + r + h + l - i) || o > C(s)) && (t.left += r + h + l)
            },
            top: function(t, e) {
                var i = e.within,
                    ...
                    l = -2 * e.offset[1];
                a < 0 ? ((n = t.top + r + h + l + e.collisionHeight - n - s) < 0 || C(a) > n) && (t.top += r + h + l) : 0 < o && (0 < (s = t.top - e.collisionPosition.marginTop + r + h + l - i) || o > C(s)) && (t.top += r + h + l)
            }
        },
        flipfit: {
            left: function() {
    ...
    var u, Y, j, q, K, U, V, $, X, G, d, p, f, Q, J, g, m, _, v, b, y, w = "ui-effects-",
        I = "ui-effects-style",
    ...
    function it(s) {
        var n = g(),
            o = n._rgba = [];
        return s = s.toLowerCase(), y(J, function(t, e) {
            var i = e.re.exec(s),
                i = i && e.parse(i),
                e = e.space || "rgba";
            return i ? (i = n[e](i), n[m[e].cache] = i[m[e].cache], o = n._rgba = i._rgba, !1) : p
    ...
    k.effects = {
    ...
    }, v = g.support = {}, b = d("<p>")[0], y = d.each, b.style.cssText = "background-color:rgba(1,1,1,.5)", v.rgba = -1 < b.style.backgroundColor.indexOf("rgba"), y(m, function(t, e) {
        ...
        parse: function(n, t, e, i) {
            if (n === p) return this._rgba = [null, null, null, null], this;
            (n.jquery || n.nodeType) && (n = d(n).css(t), t = p);
            var o = this,
                s = d.type(n),
                a = this._rgba = [];
            return t !== p && (n = [n, t, e, i], s = "array"), "string" === s ? this.parse(it(n) || f._default) : "array" === s ? (y(m.rgba.props, function(t, e) {
                a[e.idx] = S(n[e.idx], e)
            }), this) : "object" === s ? (n instanceof g ? y(m, function(t, e) {
        ...
        is: function(t) {
            ...
            return y(m, function(t, e) {
                ...
                return s && (i = a[e.cache] || e.to && e.to(a._rgba) || [], y(e.props, function(t, e) {
                    return null != s[e.idx] ? o = s[e.idx] === i[e.idx] : p
                })), o
            }), o
        },
        _space: function() {
        ...
        transition: function(t, a) {
            var t = (l = g(t))._space(),
                e = m[t],
                i = 0 === this.alpha() ? g("transparent") : this,
                r = i[e.cache] || e.to(i._rgba),
                h = r.slice(),
                l = l[e.cache];
            return y(e.props, function(t, e) {
                var i = e.idx,
                    s = r[i],
                    n = l[i],
                    o = _[e.type] || {};
        ...
        blend: function(t) {
            var e, i, s;
            return 1 === this._rgba[3] ? this : (e = this._rgba.slice(), i = e.pop(), s = g(t)._rgba, g(d.map(e, function(t, e) {
                return (1 - i) * s[e] + i * t
            })))
        },
    ...
    })).parse.prototype = g.fn, m.hsla.to = function(t) {
        var e, i, s, n, o, a, r, h;
        return null == t[0] || null == t[1] || null == t[2] ? [null, null, null, t[3]] : (e = t[0] / 255, i = t[1] / 255, s = t[2] / 255, t = t[3], r = .5 * (h = (n = Math.max(e, i, s)) + (o = Math.min(e, i, s))), h = 0 == (a = n - o) ? 0 : r <= .5 ? a / h : a / (2 - h), [Math.round(o === n ? 0 : e === n ? 60 * (i - s) / a + 360 : i === n ? 60 * (s - e) / a + 120 : 60 * (e - i) / a + 240) % 360, h, r, null == t ? 1 : t])
    }, m.hsla.from = function(t) {
        var e, i, s;
        return null == t[0] || null == t[1] || null == t[2] ? [null, null, null, t[3]] : (e = t[0] / 360, s = t[1], i = t[2], t = t[3], s = 2 * i - (i = i <= .5 ? i * (1 + s) : i + s - i * s), [Math.round(255 * H(s, i, e + 1 / 3)), Math.round(255 * H(s, i, e)), Math.round(255 * H(s, i, e - 1 / 3)), t])
    }, y(m, function(r, t) {
        var o = t.props,
            a = t.cache,
            h = t.to,
        ...
        g.fn[r] = function(t) {
            var e, i, s, n;
            return h && !this[a] && (this[a] = h(this._rgba)), t === p ? this[a].slice() : (i = d.type(t), s = "array" === i || "object" === i ? t : arguments, n = this[a].slice(), y(o, function(t, e) {
                t = s["object" === i ? t : e.idx];
                null == t && (t = n[e.idx]), n[e.idx] = S(t, e)
            }), l ? ((e = g(l(n)))[a] = n, e) : g(n))
        }, y(o, function(o, a) {
            g.fn[o] || (g.fn[o] = function(t) {
                var e = d.type(t),
                    i = "alpha" === o ? this._hsla ? "hsla" : "rgba" : r,
                    s = this[i](),
                    n = s[a.idx];
                return "undefined" === e ? n : ("function" === e && (t = t.call(this, n), e = d.type(t)), null == t && a.empty ? this : ("string" === e && (e = Q.exec(t)) && (t = n + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), s[a.idx] = t, this[i](s)))
            })
        })
    }), (g.hook = function(t) {
        t = t.split(" ");
        y(t, function(t, o) {
            d.cssHooks[o] = {
                set: function(t, e) {
                    var i, s, n = "";
                    if ("transparent" !== e && ("string" !== d.type(e) || (i = it(e)))) {
                ...
                t.colorInit || (t.start = g(t.elem, o), t.end = g(t.end), t.colorInit = !0), d.cssHooks[o].set(t.elem, t.start.transition(t.end, t.pos))
            }
        })
        ...
        return this.queue(function() {
            ...
            s(), e = e.map(function() {
                return this.end = et(this.el[0]), this.diff = function(t, e) {
                    var i, s, n = {};
                    for (i in e) s = e[i], t[i] === s || G[i] || !k.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s);
                    return n
        ...
        toggleClass: (U = k.fn.toggleClass, function(t, e, i, s, n) {
            return "boolean" == typeof e || void 0 === e ? i ? k.effects.animateClass.call(this, e ? {
                add: t
            } : {
                remove: t
            }, i, s, n) : U.apply(this, arguments) : k.effects.animateClass.call(this, {
                toggle: t
            }, e, i, s)
        }),
        ...
        effect: function() {
            function t(t) {
                ...
                var i = k(this);
                s.mode = l.shift(), !1 === k.uiBackCompat || o ? "none" === s.mode ? (i[h](), e()) : n.call(i[0], s, function() {
                    i.removeData(T), k.effects.cleanUp(i), "hide" === s.mode && i.hide(), e()
                }) : (i.is(":hidden") ? "hide" === h : "show" === h) ? (i[h](), e()) : n.call(i[0], s, e)
            }

            function e(t) {
                var e = k(this),
                    i = k.effects.mode(e, h) || o;
                e.data(T, !0), l.push(i), o && ("show" === i || i === o && "hide" === i) && e.show(), o && "none" === i || k.effects.saveStyle(e), k.isFunction(t) && t()
            }
            var s = P.apply(this, arguments),
                ...
                h = s.mode,
                l = [];
            return k.fx.off || !n ? h ? this[h](s.duration, r) : this.each(function() {
                r && r.call(this)
            }) : !1 === i ? this.each(e).each(t) : this.queue(a, e).queue(a, t)
        },
        show: (q = k.fn.show, function(t) {
            var e;
            return M(t) ? q.apply(this, arguments) : ((e = P.apply(this, arguments)).mode = "show", this.effect.call(this, e))
        }),
        hide: (j = k.fn.hide, function(t) {
            var e;
            return M(t) ? j.apply(this, arguments) : ((e = P.apply(this, arguments)).mode = "hide", this.effect.call(this, e))
        }),
        toggle: (Y = k.fn.toggle, function(t) {
            var e;
            return M(t) || "boolean" == typeof t ? Y.apply(this, arguments) : ((e = P.apply(this, arguments)).mode = "toggle", this.effect.call(this, e))
        }),
        cssUnit: function(t) {
            var i = this.css(t),
                s = [];
        ...
        cssClip: function(t) {
            return t ? this.css("clip", "rect(" + t.top + "px " + t.right + "px " + t.bottom + "px " + t.left + "px)") : tt(this.css("clip"), this)
        },
        ...
        t.clipInit || (t.start = k(t.elem).cssClip(), "string" == typeof t.end && (t.end = tt(t.end, t.elem)), t.clipInit = !0), k(t.elem).cssClip({
            top: t.pos * (t.end.top - t.start.top) + t.start.top,
            right: t.pos * (t.end.right - t.start.right) + t.start.right,
            bottom: t.pos * (t.end.bottom - t.start.bottom) + t.start.bottom,
            left: t.pos * (t.end.left - t.start.left) + t.start.left
        })
    }, u = {}, k.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e, t) {
        u[t] = function(t) {
    ...
    k.effects.define("blind", "hide", function(t, e) {
        ...
        var i, s, n = k(this),
            ...
            g = 0,
            t = n.queue().length;
        for (k.effects.createPlaceholder(n), r = n.css(p), h = h || n["top" == p ? "outerHeight" : "outerWidth"]() / 3, o && ((s = {
                opacity: 1
            })[p] = r, n.css("opacity", 0).css(p, f ? 2 * -h : 2 * h).animate(s, u, d)), a && (h /= Math.pow(2, l - 1)), (s = {})[p] = r; g < l; g++)(i = {})[p] = (f ? "-=" : "+=") + h, n.animate(i, u, d).animate(s, u, d), h = a ? 2 * h : h / 2;
        a && ((i = {
            opacity: 0
        })[p] = (f ? "-=" : "+=") + h, n.animate(i, u, d)), n.queue(e), k.effects.unshift(n, t, 1 + c)
        ...
        k.effects.createPlaceholder(s), i = t.distance || s["top" == a ? "outerHeight" : "outerWidth"](!0) / 2, h[a] = o + i, n && (s.css(h), h[a] = r + i, h.opacity = 1), s.animate(h, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: e
        ...
        for (var s, n, o, a, r, h = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, l = h, c = k(this), u = "show" === t.mode, d = c.show().css("visibility", "hidden").offset(), p = Math.ceil(c.outerWidth() / l), f = Math.ceil(c.outerHeight() / h), g = [], m = 0; m < h; m++)
            for (o = d.top + m * f, r = m - (h - 1) / 2, s = 0; s < l; s++) n = d.left + s * p, a = s - (l - 1) / 2, c.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -s * p,
                top: -m * f
        ...
        var i = k(this),
            ...
            p = [c[r[0]], c[r[1]]],
            f = i.queue().length;
        a && (o = parseInt(a[1], 10) / 100 * p[s ? 0 : 1]), u.clip[r[0]] = o, d.clip[r[0]] = o, d.clip[r[1]] = 0, n && (i.cssClip(d.clip), l && l.css(k.effects.clipToBox(d)), d.clip = c), i.queue(function(t) {
            l && l.animate(k.effects.clipToBox(u), h, e.easing).animate(k.effects.clipToBox(d), h, e.easing), t()
        }).animate(u, h, e.easing).animate(d, h, e.easing).queue(t), k.effects.unshift(i, f, 4)
        ...
        t.fade && (i.from.opacity = 1, i.to.opacity = 0), k.effects.effect.size.call(this, i, e)
        ...
        var i = 1,
            ...
            d = {},
            p = s.queue().length;
        for (k.effects.createPlaceholder(s), c[l] = (n ? "-=" : "+=") + o, u[l] = (n ? "+=" : "-=") + 2 * o, d[l] = (n ? "-=" : "+=") + 2 * o, s.animate(c, h, t.easing); i < a; i++) s.animate(u, h, t.easing).animate(d, h, t.easing);
        s.animate(u, h, t.easing).animate(c, h / 2, t.easing).queue(e), k.effects.unshift(s, p, 1 + r)
        ...
        return "area" === o ? (n = (i = t.parentNode).name, !(!t.href || !n || "map" !== i.nodeName.toLowerCase()) && 0 < (i = k("img[usemap='#" + n + "']")).length && i.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(o) ? (s = !t.disabled) && (n = k(t).closest("fieldset")[0]) && (s = !n.disabled) : s = "a" === o && t.href || e, s && k(t).is(":visible") && function(t) {
        ...
        TAB: 9,
        UP: 38
    }, k.ui.escapeSelector = (nt = /([!"#$%&'()*+,.\/:;<=>?@[\]^`{|}~])/g, function(t) {
        ...
        uniqueId: (st = 0, function() {
            return this.each(function() {
                this.id || (this.id = "ui-id-" + ++st)
            })
        }),
        ...
        refresh: function() {
            ...
            this._toggleClass("ui-menu-icons", null, !!this.element.find(".ui-icon").length), t = i.filter(":not(.ui-menu)").hide().attr({
                ...
                tabIndex: -1,
                role: this._itemRole()
            }), this._addClass(i, "ui-menu-item")._addClass(e, "ui-menu-item-wrapper"), t.filter(".ui-state-disabled").attr("aria-disabled", "true"), this.active && !k.contains(this.element[0], this.active[0]) && this.blur()
        },
        _itemRole: function() {
            return {
                menu: "menuitem",
        ...
        _scrollIntoView: function(t) {
            var e, i, s;
            this._hasScroll() && (e = parseFloat(k.css(this.activeMenu[0], "borderTopWidth")) || 0, i = parseFloat(k.css(this.activeMenu[0], "paddingTop")) || 0, e = t.offset().top - this.activeMenu.offset().top - e - i, i = this.activeMenu.scrollTop(), s = this.activeMenu.height(), t = t.outerHeight(), e < 0 ? this.activeMenu.scrollTop(i + e) : s < e + t && this.activeMenu.scrollTop(i + e - s + t))
        },
        blur: function(t, e) {
            ...
            this.isMultiLine = e || !t && this._isContentEditable(this.element), this.valueMethod = this.element[e || t ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, {
                ...
                menufocus: function(t, e) {
                    ...
                    return this.isNewMenu && (this.isNewMenu = !1, t.originalEvent) && /^mouse/.test(t.originalEvent.type) ? (this.menu.blur(), void this.document.one("mousemove", function() {
                        ...
                        item: i
                    }) && t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(i.value), void((e = e.item.attr("aria-label") || i.value) && k.trim(e).length && (this.liveRegion.children().hide(), k("<div>").text(e).appendTo(this.liveRegion))))
                },
        ...
        _appendTo: function() {
            ...
            return t = (t = (t = t && (t.jquery || t.nodeType ? k(t) : this.document.find(t).eq(0))) && t[0] ? t : this.element.closest(".ui-front, dialog")).length ? t : this.document[0].body
        },
    ...
    var st, nt, ot, z, O, at = /ui-corner-([a-z]){2,6}/g,
        A = (k.widget("ui.controlgroup", {
            version: "1.12.1",
            defaultElement: "<div>",
            options: {
            ...
            _updateIcon: function(t, e) {
                var t = "iconPosition" !== t,
                    ...
                    s = "top" === i || "bottom" === i;
                this.icon ? t && this._removeClass(this.icon, null, this.options.icon) : (this.icon = k("<span>"), this._addClass(this.icon, "ui-button-icon", "ui-icon"), this.options.showLabel || this._addClass("ui-button-icon-only")), t && this._addClass(this.icon, null, e), this._attachIcon(i), s ? (this._addClass(this.icon, null, "ui-widget-icon-block"), this.iconSpace && this.iconSpace.remove()) : (this.iconSpace || (this.iconSpace = k("<span> </span>"), this._addClass(this.iconSpace, "ui-button-icon-space")), this._removeClass(this.icon, null, "ui-wiget-icon-block"), this._attachIconSpace(i))
            },
            _destroy: function() {
        ...
        }), k.fn.button = (ot = k.fn.button, function() {
            return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? ot.apply(this, arguments) : (k.ui.checkboxradio || k.error("Checkboxradio widget missing"), 0 === arguments.length ? this.checkboxradio({
                icon: !1
            ...
            _dialogDatepicker: function(t, e, i, s, n) {
                ...
                return a || (this.uuid += 1, o = "dp" + this.uuid, this._dialogInput = k("<input type='text' id='" + o + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.on("keydown", this._doKeyDown), k("body").append(this._dialogInput), (a = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, k.data(this._dialogInput[0], "datepicker", a)), h(a.settings, s || {}), e = e && e.constructor === Date ? this._formatDate(a, e) : e, this._dialogInput.val(e), this._pos = n ? n.length ? n : [n.pageX, n.pageY] : null, this._pos || (o = document.documentElement.clientWidth, s = document.documentElement.clientHeight, e = document.documentElement.scrollLeft || document.body.scrollLeft, n = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [o / 2 - 100 + e, s / 2 - 150 + n]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), a.settings.onSelect = i, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), this._showDatepicker(this._dialogInput[0]), k.blockUI && k.blockUI(this.dpDiv), k.data(this._dialogInput[0], "datepicker", a), this
            },
            _destroyDatepicker: function(t) {
                var e, i = k(t),
                    s = k.data(t, "datepicker");
                i.hasClass(this.markerClassName) && (e = t.nodeName.toLowerCase(), k.removeData(t, "datepicker"), "input" === e ? (s.append.remove(), s.trigger.remove(), i.removeClass(this.markerClassName).off("focus", this._showDatepicker).off("keydown", this._doKeyDown).off("keypress", this._doKeyPress).off("keyup", this._doKeyUp)) : "div" !== e && "span" !== e || i.removeClass(this.markerClassName).empty(), z === s) && (z = null)
            },
            _enableDatepicker: function(e) {
                ...
                i.hasClass(this.markerClassName) && ("input" === (t = e.nodeName.toLowerCase()) ? (e.disabled = !1, s.trigger.filter("button").each(function() {
                    ...
                    opacity: "1.0",
                    cursor: ""
                })) : "div" !== t && "span" !== t || ((s = i.children("." + this._inlineClass)).children().removeClass("ui-state-disabled"), s.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !1)), this._disabledInputs = k.map(this._disabledInputs, function(t) {
                    return t === e ? null : t
                }))
            },
            _disableDatepicker: function(e) {
                ...
                i.hasClass(this.markerClassName) && ("input" === (t = e.nodeName.toLowerCase()) ? (e.disabled = !0, s.trigger.filter("button").each(function() {
                    ...
                    opacity: "0.5",
                    cursor: "default"
                })) : "div" !== t && "span" !== t || ((s = i.children("." + this._inlineClass)).children().addClass("ui-state-disabled"), s.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !0)), this._disabledInputs = k.map(this._disabledInputs, function(t) {
                    return t === e ? null : t
            ...
            _optionDatepicker: function(t, e, i) {
                ...
                return 2 === arguments.length && "string" == typeof e ? "defaults" === e ? k.extend({}, k.datepicker._defaults) : r ? "all" === e ? k.extend({}, r.settings) : this._get(r, e) : null : (s = e || {}, "string" == typeof e && ((s = {})[e] = i), void(r && (this._curInst === r && this._hideDatepicker(), n = this._getDateDatepicker(t, !0), o = this._getMinMaxDate(r, "min"), a = this._getMinMaxDate(r, "max"), h(r.settings, s), null !== o && void 0 !== s.dateFormat && void 0 === s.minDate && (r.settings.minDate = this._formatDate(r, o)), null !== a && void 0 !== s.dateFormat && void 0 === s.maxDate && (r.settings.maxDate = this._formatDate(r, a)), "disabled" in s && (s.disabled ? this._disableDatepicker(t) : this._enableDatepicker(t)), this._attachments(k(t), r), this._autoSize(r), this._setDate(r, n), this._updateAlternate(r), this._updateDatepicker(r))))
            },
            ...
            _doKeyDown: function(t) {
                ...
                if (s._keyEvent = !0, k.datepicker._datepickerShowing) switch (t.keyCode) {
                    case 9:
                        ...
                        break;
                    case 13:
                        return (i = k("td." + k.datepicker._dayOverClass + ":not(." + k.datepicker._currentClass + ")", s.dpDiv))[0] && k.datepicker._selectDay(t.target, s.selectedMonth, s.selectedYear, i[0]), (i = k.datepicker._get(s, "onSelect")) ? (e = k.datepicker._formatDate(s), i.apply(s.input ? s.input[0] : null, [e, s])) : k.datepicker._hideDatepicker(), !1;
                    case 27:
            ...
            _doKeyPress: function(t) {
                ...
                return k.datepicker._get(i, "constrainInput") ? (i = k.datepicker._possibleChars(k.datepicker._get(i, "dateFormat")), e = String.fromCharCode(null == t.charCode ? t.keyCode : t.charCode), t.ctrlKey || t.metaKey || e < " " || !i || -1 < i.indexOf(e)) : void 0
            },
            _doKeyUp: function(t) {
            ...
            _showDatepicker: function(t) {
                ...
                "input" !== (t = t.target || t).nodeName.toLowerCase() && (t = k("input", t.parentNode)[0]), k.datepicker._isDisabledDatepicker(t) || k.datepicker._lastInput === t || (n = k.datepicker._getInst(t), k.datepicker._curInst && k.datepicker._curInst !== n && (k.datepicker._curInst.dpDiv.stop(!0, !0), n) && k.datepicker._datepickerShowing && k.datepicker._hideDatepicker(k.datepicker._curInst.input[0]), !1 !== (i = (i = k.datepicker._get(n, "beforeShow")) ? i.apply(t, [t, n]) : {}) && (h(n.settings, i), n.lastVal = null, k.datepicker._lastInput = t, k.datepicker._setDateFromField(n), k.datepicker._inDialog && (t.value = ""), k.datepicker._pos || (k.datepicker._pos = k.datepicker._findPos(t), k.datepicker._pos[1] += t.offsetHeight), e = !1, k(t).parents().each(function() {
                    ...
                    display: "block",
                    top: "-1000px"
                }), k.datepicker._updateDatepicker(n), i = k.datepicker._checkOffset(n, i, e), n.dpDiv.css({
            ...
            _updateDatepicker: function(t) {
                this.maxRows = 4, (z = t).dpDiv.empty().append(this._generateHTML(t)), this._attachHandlers(t);
            ...
            _hideDatepicker: function(t) {
                ...
                !s || t && s !== k.data(t, "datepicker") || this._datepickerShowing && (t = this._get(s, "showAnim"), i = this._get(s, "duration"), e = function() {
                    k.datepicker._tidyDialog(s)
                }, k.effects && (k.effects.effect[t] || k.effects[t]) ? s.dpDiv.hide(t, k.datepicker._get(s, "showOptions"), i, e) : s.dpDiv["slideDown" === t ? "slideUp" : "fadeIn" === t ? "fadeOut" : "hide"](t ? i : null, e), t || e(), this._datepickerShowing = !1, (i = this._get(s, "onClose")) && i.apply(s.input ? s.input[0] : null, [s.input ? s.input.val() : "", s]), this._lastInput = null, this._inDialog && (this._dialogInput.css({
                    position: "absolute",
                    left: "0",
                    top: "-100px"
            ...
            _checkExternalClick: function(t) {
                var e;
                k.datepicker._curInst && (t = k(t.target), e = k.datepicker._getInst(t[0]), !(t[0].id === k.datepicker._mainDivId || 0 !== t.parents("#" + k.datepicker._mainDivId).length || t.hasClass(k.datepicker.markerClassName) || t.closest("." + k.datepicker._triggerClass).length || !k.datepicker._datepickerShowing || k.datepicker._inDialog && k.blockUI) || t.hasClass(k.datepicker.markerClassName) && k.datepicker._curInst !== e) && k.datepicker._hideDatepicker()
            },
            ...
            _updateAlternate: function(t) {
                ...
                s && (i = this._get(t, "altFormat") || this._get(t, "dateFormat"), e = this._getDate(t), i = this.formatDate(i, e, this._getFormatConfig(t)), k(s).val(i))
            },
            ...
            parseDate: function(e, n, t) {
                ...
                for (var a, r, h = 0, l = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff, l = "string" != typeof l ? l : (new Date).getFullYear() % 100 + parseInt(l, 10), c = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, u = (t ? t.dayNames : null) || this._defaults.dayNames, d = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, p = (t ? t.monthNames : null) || this._defaults.monthNames, f = -1, g = -1, m = -1, _ = -1, v = !1, b = function(t) {
                        t = e.length > y + 1 && e.charAt(y + 1) === t;
                        return t && y++, t
                    }, y = 0; e.length > y; y++)
                    if (v) "'" !== e.charAt(y) || b("'") ? o() : v = !1;
                        ...
                        case "y":
                            ...
                            break;
                        case "@":
                            f = (r = new Date(i("@"))).getFullYear(), g = r.getMonth() + 1, m = r.getDate();
                            break;
                        case "!":
                            f = (r = new Date((i("!") - this._ticksTo1970) / 1e4)).getFullYear(), g = r.getMonth() + 1, m = r.getDate();
                            break;
                        case "'":
                            b("'") ? o() : v = !0;
                            break;
                ...
                if (n.length > h && (t = n.substr(h), !/^\s+/.test(t))) throw "Extra/unparsed characters found in date: " + t;
                if (-1 === f ? f = (new Date).getFullYear() : f < 100 && (f += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (f <= l ? 0 : -100)), -1 < _)
                    for (g = 1, m = _; !(m <= (a = this._getDaysInMonth(f, g - 1)));) g++, m -= a;
            ...
            _generateHTML: function(t) {
                var e, i, s, n, o, W, E, F, R, a, r, L, h, l, c, u, d, p, f, g, m, _, B, v, b, y, w, Y, j, k, x, C, D = new Date,
                ...
                for (t.drawMonth = A, t.drawYear = N, S = this._get(t, "prevText"), S = P ? this.formatDate(S, this._daylightSavingAdjust(new Date(N, A - H, 1)), this._getFormatConfig(t)) : S, i = this._canAdjustMonth(t, -1, N, A) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + S + "'><span class='ui-icon ui-icon-circle-triangle-" + (I ? "e" : "w") + "'>" + S + "</span></a>" : T ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + S + "'><span class='ui-icon ui-icon-circle-triangle-" + (I ? "e" : "w") + "'>" + S + "</span></a>", S = this._get(t, "nextText"), S = P ? this.formatDate(S, this._daylightSavingAdjust(new Date(N, A + H, 1)), this._getFormatConfig(t)) : S, s = this._canAdjustMonth(t, 1, N, A) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + S + "'><span class='ui-icon ui-icon-circle-triangle-" + (I ? "w" : "e") + "'>" + S + "</span></a>" : T ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + S + "'><span class='ui-icon ui-icon-circle-triangle-" + (I ? "w" : "e") + "'>" + S + "</span></a>", H = this._get(t, "currentText"), T = this._get(t, "gotoCurrent") && t.currentDay ? U : q, H = P ? this.formatDate(H, T, this._getFormatConfig(t)) : H, S = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", P = D ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (I ? S : "") + (this._isInRange(t, T) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + H + "</button>" : "") + (I ? "" : S) + "</div>" : "", n = parseInt(this._get(t, "firstDay"), 10), n = isNaN(n) ? 0 : n, o = this._get(t, "showWeek"), W = this._get(t, "dayNames"), E = this._get(t, "dayNamesMin"), F = this._get(t, "monthNames"), R = this._get(t, "monthNamesShort"), a = this._get(t, "beforeShowDay"), r = this._get(t, "showOtherMonths"), L = this._get(t, "selectOtherMonths"), h = this._getDefaultDate(t), l = "", u = 0; M[0] > u; u++) {
                    for (d = "", this.maxRows = 4, p = 0; M[1] > p; p++) {
                        ...
                        for (m += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + g + "'>" + (/all|left/.test(g) && 0 === u ? I ? s : i : "") + (/all|right/.test(g) && 0 === u ? I ? i : s : "") + this._generateMonthYearHeader(t, A, N, z, O, 0 < u || 0 < p, F, R) + "</div><table class='ui-datepicker-calendar'><thead><tr>", _ = o ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", c = 0; c < 7; c++) _ += "<th scope='col'" + (5 <= (c + n + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + W[B = (c + n) % 7] + "'>" + E[B] + "</span></th>";
                        for (m += _ + "</tr></thead><tbody>", b = this._getDaysInMonth(N, A), N === t.selectedYear && A === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, b)), v = (this._getFirstDayOfMonth(N, A) - n + 7) % 7, b = Math.ceil((v + b) / 7), y = K && this.maxRows > b ? this.maxRows : b, this.maxRows = y, w = this._daylightSavingAdjust(new Date(N, A, 1 - v)), Y = 0; Y < y; Y++) {
                            for (m += "<tr>", j = o ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(w) + "</td>" : "", c = 0; c < 7; c++) k = a ? a.apply(t.input ? t.input[0] : null, [w]) : [!0, ""], C = (x = w.getMonth() !== A) && !L || !k[0] || z && w < z || O && O < w, j += "<td class='" + (5 <= (c + n + 6) % 7 ? " ui-datepicker-week-end" : "") + (x ? " ui-datepicker-other-month" : "") + (w.getTime() === f.getTime() && A === t.selectedMonth && t._keyEvent || h.getTime() === w.getTime() && h.getTime() === f.getTime() ? " " + this._dayOverClass : "") + (C ? " " + this._unselectableClass + " ui-state-disabled" : "") + (x && !r ? "" : " " + k[1] + (w.getTime() === U.getTime() ? " " + this._currentClass : "") + (w.getTime() === q.getTime() ? " ui-datepicker-today" : "")) + "'" + (x && !r || !k[2] ? "" : " title='" + k[2].replace(/'/g, "&#39;") + "'") + (C ? "" : " data-handler='selectDay' data-event='click' data-month='" + w.getMonth() + "' data-year='" + w.getFullYear() + "'") + ">" + (x && !r ? "&#xa0;" : C ? "<span class='ui-state-default'>" + w.getDate() + "</span>" : "<a class='ui-state-default" + (w.getTime() === q.getTime() ? " ui-state-highlight" : "") + (w.getTime() === U.getTime() ? " ui-state-active" : "") + (x ? " ui-priority-secondary" : "") + "' href='#'>" + w.getDate() + "</a>") + "</td>", w.setDate(w.getDate() + 1), w = this._daylightSavingAdjust(w);
                            m += j + "</tr>"
                        }
                        11 < ++A && (A = 0, N++), d += m += "</tbody></table>" + (K ? "</div>" + (0 < M[0] && p === M[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                    }
                    l += d
                }
            ...
            _generateMonthYearHeader: function(t, e, i, s, n, o, a, r) {
                ...
                if (o || !g) b += "<span class='ui-datepicker-month'>" + a[e] + "</span>";
                    ...
                    for (h = s && s.getFullYear() === i, l = n && n.getFullYear() === i, b += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", c = 0; c < 12; c++)(!h || c >= s.getMonth()) && (!l || n.getMonth() >= c) && (b += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + r[c] + "</option>");
                    b += "</select>"
                }
            ...
            _isInRange: function(t, e) {
                ...
                return t && (t = t.split(":"), i = (new Date).getFullYear(), o = parseInt(t[0], 10), a = parseInt(t[1], 10), t[0].match(/[+\-].*/) && (o += i), t[1].match(/[+\-].*/)) && (a += i), (!s || e.getTime() >= s.getTime()) && (!n || e.getTime() <= n.getTime()) && (!o || e.getFullYear() >= o) && (!a || a >= e.getFullYear())
            },
        ...
        }, k.datepicker = new t, k.datepicker.initialized = !1, k.datepicker.uuid = (new Date).getTime(), k.datepicker.version = "1.12.1", k.datepicker, k.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase()), !1),
        N = (k(document).on("mouseup", function() {
            A = !1
        }), k.widget("ui.mouse", {
            version: "1.12.1",
            options: {
            ...
            _mouseDown: function(t) {
                var e, i, s;
                if (!A) return this._mouseMoved = !1, this._mouseStarted && this._mouseUp(t), i = 1 === (this._mouseDownEvent = t).which, s = !("string" != typeof(e = this).options.cancel || !t.target.nodeName) && k(t.target).closest(this.options.cancel).length, i && !s && this._mouseCapture(t) && (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    e.mouseDelayMet = !0
            ...
            _mouseUp: function(t) {
                this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && k.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, A = !1, t.preventDefault()
            },
            ...
            drag: function(t, e, i) {
                for (var s, n, o, a, r, h, l, c, u, d = i.options, p = d.snapTolerance, f = e.offset.left, g = f + i.helperProportions.width, m = e.offset.top, _ = m + i.helperProportions.height, v = i.snapElements.length - 1; 0 <= v; v--) h = (r = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width, c = (l = i.snapElements[v].top - i.margins.top) + i.snapElements[v].height, g < r - p || h + p < f || _ < l - p || c + p < m || !k.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item) ? (i.snapElements[v].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, k.extend(i._uiHash(), {
                ...
                })), i.snapElements[v].snapping = !1) : ("inner" !== d.snapMode && (s = p >= Math.abs(l - _), n = p >= Math.abs(c - m), o = p >= Math.abs(r - g), a = p >= Math.abs(h - f), s && (e.position.top = i._convertPositionTo("relative", {
                    ...
                    top: 0,
                    left: h
                }).left), u = s || n || o || a, "outer" !== d.snapMode && (s = p >= Math.abs(l - m), n = p >= Math.abs(c - _), o = p >= Math.abs(r - f), a = p >= Math.abs(h - g), s && (e.position.top = i._convertPositionTo("relative", {
                    top: l,
                    left: 0
                }).top), n && (e.position.top = i._convertPositionTo("relative", {
            ...
            _hasScroll: function(t, e) {
                var i;
                return "hidden" !== k(t).css("overflow") && (i = !1, 0 < t[e = e && "left" === e ? "scrollLeft" : "scrollTop"] || (t[e] = 1, i = 0 < t[e], t[e] = 0, i))
            },
            _create: function() {
                var t, e = this.options,
                    i = this;
            ...
            _setupHandles: function() {
                ...
                if (this.handles = o.handles || (k(".ui-resizable-handle", this.element).length ? {
                    ...
                    for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; i.length > e; e++) s = "ui-resizable-" + (t = k.trim(i[e])), n = k("<div>"), this._addClass(n, "ui-resizable-handle " + s), n.css({
                        zIndex: o.zIndex
            ...
            _mouseCapture: function(t) {
                var e, i, s = !1;
                for (e in this.handles) i = k(this.handles[e])[0], i !== t.target && !k.contains(i, t.target) || (s = !0);
            ...
            _mouseDrag: function(t) {
                var e = this.originalMousePosition,
                    ...
                    e = t.pageY - e.top || 0,
                    i = this._change[i];
                return this._updatePrevProperties(), i && (i = i.apply(this, [t, s, e]), this._updateVirtualBoundaries(t.shiftKey), (this._aspectRatio || t.shiftKey) && (i = this._updateRatio(i, t)), i = this._respectSize(i, t), this._updateCache(i), this._propagate("resize", t), s = this._applyChanges(), !this._helper && this._proportionallyResizeElements.length && this._proportionallyResize(), k.isEmptyObject(s) || (this._updatePrevProperties(), this._trigger("resize", t, this.ui()), this._applyChanges())), !1
            },
            _mouseStop: function(t) {
                this.resizing = !1;
            ...
            stop: function(e) {
                ...
                i.element.animate(k.extend(n, a && o ? {
                    top: a,
                    left: o
                } : {}), {
            ...
            start: function() {
                var i, s, t, e, n = k(this).resizable("instance"),
                    o = n.options,
                    a = n.element,
                    o = o.containment,
                    a = o instanceof k ? o.get(0) : /parent/.test(o) ? a.parent().get(0) : o;
            ...
            _createWrapper: function() {
                this.uiDialog = k("<div>").hide().attr({
                    ...
                    keydown: function(t) {
                        var e, i, s;
                        this.options.closeOnEscape && !t.isDefaultPrevented() && t.keyCode && t.keyCode === k.ui.keyCode.ESCAPE ? (t.preventDefault(), this.close(t)) : t.keyCode !== k.ui.keyCode.TAB || t.isDefaultPrevented() || (e = this.uiDialog.find(":tabbable"), i = e.filter(":first"), s = e.filter(":last"), t.target !== s[0] && t.target !== this.uiDialog[0] || t.shiftKey ? t.target !== i[0] && t.target !== this.uiDialog[0] || !t.shiftKey || (this._delay(function() {
                            s.trigger("focus")
                ...
                this.uiDialog.draggable({
                    ...
                    stop: function(t, e) {
                        ...
                        a.position = {
                            ...
                            of: o.window
                        }, o._removeClass(k(this), "ui-dialog-dragging"), o._unblockFrames(), o._trigger("dragStop", t, n(e))
                    }
                })
            },
            _makeResizable: function() {
                ...
                this.uiDialog.resizable({
                    ...
                    handles: t,
                    start: function(t, e) {
                        o._addClass(k(this), "ui-dialog-resizing"), o._blockFrames(), o._trigger("resizeStart", t, n(e))
                    },
                    resize: function(t, e) {
                    ...
                    stop: function(t, e) {
                        ...
                        a.height = o.uiDialog.height(), a.width = o.uiDialog.width(), a.position = {
                            ...
                            of: o.window
                        }, o._removeClass(k(this), "ui-dialog-resizing"), o._unblockFrames(), o._trigger("resizeStop", t, n(e))
                    }
                }).css("position", e)
            },
            ...
            _drop: function(e, t) {
                ...
                return !(!i || (i.currentItem || i.element)[0] === this.element[0] || (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function() {
                    ...
                    return t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && N(i, k.extend(t, {
            ...
            switch (i) {
                ...
                case "pointer":
                    return rt(s.pageY, l, e.proportions().height) && rt(s.pageX, h, e.proportions().width);
                case "touch":
    ...
    function rt(t, e, i) {
        ...
        drop: function(t, e) {
            ...
            return k.each((k.ui.ddmanager.droppables[t.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && N(t, this, this.options.tolerance, e) && (i = this._drop.call(this, e) || i), !this.options.disabled) && this.visible && this.accept.call(this.element[0], t.currentItem || t.element) && (this.isout = !0, this.isover = !1, this._deactivate.call(this, e))
            }), i
        },
        ...
        drag: function(n, o) {
            n.options.refreshPositions && k.ui.ddmanager.prepareOffsets(n, o), k.each(k.ui.ddmanager.droppables[n.options.scope] || [], function() {
                var t, e, i, s;
                this.options.disabled || this.greedyChild || !this.visible || (s = !(s = N(n, this, this.options.tolerance, o)) && this.isover ? "isout" : s && !this.isover ? "isover" : null) && (this.options.greedy && (e = this.options.scope, (i = this.element.parents(":data(ui-droppable)").filter(function() {
        ...
        _mouseDrag: function(s) {
            var t, n, o, a, r, h, l;
            if (this.dragged = !0, !this.options.disabled) return o = (n = this).options, a = this.opos[0], r = this.opos[1], h = s.pageX, l = s.pageY, h < a && (t = h, h = a, a = t), l < r && (t = l, l = r, r = t), this.helper.css({
                left: a,
                top: r,
                width: h - a,
                height: l - r
        ...
        _trimAlignValue: function(t) {
            var e, i;
            return this._valueMin() >= t ? this._valueMin() : t >= this._valueMax() ? this._valueMax() : (e = 0 < this.options.step ? this.options.step : 1, i = t - (t = (t - this._valueMin()) % e), 2 * Math.abs(t) >= e && (i += 0 < t ? e : -e), parseFloat(i.toFixed(5)))
        },
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (h && t)
                for (i = h.length - 1; 0 <= i; i--)
                    for (s = (n = k(h[i], this.document[0])).length - 1; 0 <= s; s--)(o = k.data(n[s], this.widgetFullName)) && o !== this && !o.options.disabled && r.push([k.isFunction(o.options.items) ? o.options.items.call(o.element) : k(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
            for (r.push([k.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
                    options: this.options,
                    item: this.currentItem
                }) : k(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), i = r.length - 1; 0 <= i; i--) r[i][0].each(e);
            return k(a)
        },
        ...
        _contactContainers: function(t) {
            ...
            if (c)
                if (1 === this.containers.length) this.containers[u].containerCache.over || (this.containers[u]._trigger("over", t, this._uiHash(this)), this.containers[u].containerCache.over = 1);
                    ...
                    for (i = 1e4, s = null, n = (h = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", o = h ? "width" : "height", l = h ? "pageX" : "pageY", e = this.items.length - 1; 0 <= e; e--) k.contains(this.containers[u].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (a = this.items[e].item.offset()[n], r = !1, t[l] - a > this.items[e][o] / 2 && (r = !0), i > Math.abs(t[l] - a)) && (i = Math.abs(t[l] - a), s = this.items[e], this.direction = r ? "up" : "down");
        ...
        _convertPositionTo: function(t, e) {
            e = e || this.position;
            var t = "absolute" === t ? 1 : -1,
                i = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && k.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent,
        ...
        _initialActive: function() {
            ...
            return !1 !== (i = null === i && (s && this.tabs.each(function(t, e) {
                return k(e).attr("aria-controls") === s ? (i = t, !1) : void 0
            }), null === (i = null === i ? this.tabs.index(this.tabs.filter(".ui-tabs-active")) : i) || -1 === i) ? !!this.tabs.length && 0 : i) && -1 === (i = this.tabs.index(this.tabs.eq(i))) && (i = !t && 0), i = !t && !1 === i && this.anchors.length ? 0 : i
        },
        _getCreateEventData: function() {
            return {
                tab: this.active,
        ...
        _findNextTab: function(t, e) {
            for (var i = this.tabs.length - 1; - 1 !== k.inArray(t = (t = i < t ? 0 : t) < 0 ? i : t, this.options.disabled);) t = e ? t + 1 : t - 1;
            return t
        },
        ...
        _open: function(t, e, i) {
            ...
            var n, o, a, r = k.extend({}, this.options.position);
            i && ((a = this._find(e)) ? a.tooltip.find(".ui-tooltip-content").html(i) : (e.is("[title]") && (t && "mouseover" === t.type ? e.attr("title", "") : e.removeAttr("title")), a = this._tooltip(e), n = a.tooltip, this._addDescribedBy(e, n.attr("id")), n.find(".ui-tooltip-content").html(i), this.liveRegion.children().hide(), (a = k("<div>").html(n.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"), a.removeAttr("id").find("[id]").removeAttr("id"), a.appendTo(this.liveRegion), this.options.track && t && /^mouse/.test(t.type) ? (this._on(this.document, {
                mousemove: s
            }), s(t)) : n.position(k.extend({ of: e
                ...
                n.is(":visible") && (s(r.of), clearInterval(o))

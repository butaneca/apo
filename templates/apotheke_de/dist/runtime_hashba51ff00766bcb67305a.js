    ...
    i.m = o, e = [], i.O = (r, t, o, n) => {
        if (!t) {
            ...
            for (u = 0; u < e.length; u++) {
                for (var [t, o, n] = e[u], c = !0, f = 0; f < t.length; f++)(!1 & n || a >= n) && Object.keys(i.O).every((e => i.O[e](t[f]))) ? t.splice(f--, 1) : (c = !1, n < a && (a = n));
                if (c) {
                    e.splice(u--, 1);
                    var l = o();
                    void 0 !== l && (r = l)
        ...
        r = r || [null, t({}), t([]), t(t)];
        for (var c = 2 & o && e;
            "object" == typeof c && !~r.indexOf(c); c = t(c)) Object.getOwnPropertyNames(c).forEach((r => a[r] = () => e[r]));
